...
export default class EditMovie extends Component {
    //allow react to single source of information on the form
    constructor(props) {
        super(props)
        this.state = {
            movie: {
        ...
        fetch('http://localhost:4000/v1/admin/editmovie', requestOptions)
            ...
            .then(data => {
               if (data.error) {
                    ...
                    // this.setState({
                    //     alert: {type: "alert-success", message: "Movie saved successfully!"}
                    // })
                ...
                onClick: () => {
                    ...
                    .then(data => {
                        if (data.error) {
                            ...
                            // this.setState({
                            //     alert: {type: "alert-success", message:"Movie has successfully delete"}
                            // })
                            this.props.history.push({
                                pathname: "/admin"
                            })
    ...
    componentDidMount() {
        console.log("JWT in EDIT MOVIE: " + this.props.jwt)
        if (this.props.jwt === "") {
            this.props.history.push({
                pathname: "/login"
            })
